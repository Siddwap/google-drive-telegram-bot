...
class Messages:
    ...
    AUTH_TEXT = "⛓️ **To Authorize your Google Drive account visit this [URL]({}) and send the generated code here.**\n__Visit the URL > Allow permissions > you will get a code > copy it > Send it here   YOU MAY GET A MESSAGE THAT IT IS IS NOT SAFE GET BACK TO SAFET SIMPLY CLICK ADVANCED  AND  THEN CLICK ON 'GO TO ADARSH G DRIVE(unsafe)'__"
