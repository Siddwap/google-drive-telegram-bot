...
class Messages:
    ...
    PROVIDE_YTDL_LINK = "❗**inorder to download a youtube video                                           follow the steps                               1. get the youtube link  for the youtube video  you want to downloadad                             now  simply  add  𝖒𝖆𝖌𝖎𝖈 in between ｙｏｕ and ｔｕｂｅ in the youtube link          for example your link is www.youtube.com/amckrc.                                               make it  www.you𝖒𝖆𝖌𝖎𝖈tube.com/amckrc .        once  done    open that final link in browser         there you will get options to download the video    chose   one   and enjoy    : )   **"
